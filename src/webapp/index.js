...
function renderApp () {
  ...
  render([
    ...
    h('nav.navbar.navbar-default', [
      h('h1.container-fluid', 'SHM Faucet')
    ]),
    ...
    h('section.container', [
      ...
      h('div.panel.panel-default', [
        ...
        h('div.panel-body', [
          ...
          h('button.btn.btn-success', 'request 1 SHM from faucet', {
            style: {
              margin: '4px'
            },
      ...
      h('div.panel.panel-default', [
        ...
        h('div.panel-body', [
          ...
          h('button.btn.btn-warning', '1 SHM', {
            style: {
              margin: '4px'
            },
            // disabled: state.userAddress ? null : true,
          ...
          h('button.btn.btn-warning', '10 SHM', {
            style: {
              margin: '4px'
            },
            // disabled: state.userAddress ? null : true,
          ...
          h('button.btn.btn-warning', '100 SHM', {
            style: {
              margin: '4px'
            },
            // disabled: state.userAddress ? null : true,
      ...
      h('div.panel.panel-default', [
        ...
        h('div.panel-body', {
          ...
          state.transactions.map((txHash) => {
            return link(`https://explorer-liberty20.shardeum.org/transaction/${txHash}`, txHash)
          })
        ))
      ])
